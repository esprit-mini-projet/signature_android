...
import tn.esprit.signature.databinding.FragmentPreviewBinding;

public class PreviewFragment extends Fragment implements View.OnClickListener, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private FragmentPreviewBinding mDataBinding;
    /**
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mDataBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_preview, container, false);
        mDataBinding.btnCamera.setOnClickListener(this);
        mTextureView = mDataBinding.textureView;
    ...
    private static class ImageSaver implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                mImage.compress(Bitmap.CompressFormat.JPEG, 30, output);
                //output.write(bytes);
            } catch (IOException e) {
                e.printStackTrace();
            } finally {
